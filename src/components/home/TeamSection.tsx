...
const TeamMember = ({ name, role, image, index, onClick }: TeamMemberProps) => (
  ...
  >
    ...
    <div className="w-0 h-0.5 bg-white mt-4 group-hover:w-full transition-all duration-300" />
  </motion.div>
);
                ...
                <div className="flex gap-4 mt-6">
                  {selectedMember.socialLinks.map((link, index) => (
                    <a
                      ...
                      className="p-2 bg-zinc-800 rounded-full text-gray-300 hover:bg-white/10 transition-colors"
                    >
