...
const PrivacyPolicyDialog = ({ 
  ...
  const englishPrivacyPolicy = (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <h4 className="text-md font-semibold text-white">Information We Collect</h4>
        <p className="text-gray-200 text-sm leading-relaxed">
      ...
      <div className="space-y-4">
        <h4 className="text-md font-semibold text-white">How We Use Your Information</h4>
        <p className="text-gray-200 text-sm leading-relaxed">
      ...
      <div className="space-y-4">
        <h4 className="text-md font-semibold text-white">Data Protection</h4>
        <p className="text-gray-200 text-sm leading-relaxed">
      ...
      <div className="space-y-4">
        <h4 className="text-md font-semibold text-white">Your Rights</h4>
        <p className="text-gray-200 text-sm leading-relaxed">
      ...
      <div className="space-y-4">
        <h4 className="text-md font-semibold text-white">Updates to This Policy</h4>
        <p className="text-gray-200 text-sm leading-relaxed">
  ...
  const turkishPrivacyPolicy = (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <h4 className="text-md font-semibold text-white">Topladığımız Bilgiler</h4>
        <p className="text-gray-200 text-sm leading-relaxed">
      ...
      <div className="space-y-4">
        <h4 className="text-md font-semibold text-white">Bilgilerinizi Nasıl Kullanırız</h4>
        <p className="text-gray-200 text-sm leading-relaxed">
      ...
      <div className="space-y-4">
        <h4 className="text-md font-semibold text-white">Veri Koruması</h4>
        <p className="text-gray-200 text-sm leading-relaxed">
      ...
      <div className="space-y-4">
        <h4 className="text-md font-semibold text-white">Haklarınız</h4>
        <p className="text-gray-200 text-sm leading-relaxed">
      ...
      <div className="space-y-4">
        <h4 className="text-md font-semibold text-white">İletişim</h4>
        <p className="text-gray-200 text-sm leading-relaxed">
      ...
      <div className="space-y-4">
        <h4 className="text-md font-semibold text-white">Politika Güncellemeleri</h4>
        <p className="text-gray-200 text-sm leading-relaxed">
