...
const ConsumerDisclosureDialog = ({ 
  ...
  const englishConsumerDisclosure = (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <h4 className="text-md font-semibold text-white">Purpose of Personal Data Processing</h4>
        <p className="text-gray-200 text-sm leading-relaxed">
      ...
      <div className="space-y-4">
        <h4 className="text-md font-semibold text-white">Data Sharing and Third Parties</h4>
        <p className="text-gray-200 text-sm leading-relaxed">
      ...
      <div className="space-y-4">
        <h4 className="text-md font-semibold text-white">Data Retention</h4>
        <p className="text-gray-200 text-sm leading-relaxed">
      ...
      <div className="space-y-4">
        <h4 className="text-md font-semibold text-white">Payment Security</h4>
        <p className="text-gray-200 text-sm leading-relaxed">
      ...
      <div className="space-y-4">
        <h4 className="text-md font-semibold text-white">Your Rights Under KVKK</h4>
        <p className="text-gray-200 text-sm leading-relaxed">
      ...
      <div className="space-y-4">
        ...
        <div className="text-gray-200 text-sm leading-relaxed ml-4">
  ...
  const turkishConsumerDisclosure = (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <h4 className="text-md font-semibold text-white">Kişisel Veri İşleme Amacı</h4>
        <p className="text-gray-200 text-sm leading-relaxed">
      ...
      <div className="space-y-4">
        <h4 className="text-md font-semibold text-white">Veri Paylaşımı ve Üçüncü Taraflar</h4>
        <p className="text-gray-200 text-sm leading-relaxed">
      ...
      <div className="space-y-4">
        <h4 className="text-md font-semibold text-white">Veri Saklama</h4>
        <p className="text-gray-200 text-sm leading-relaxed">
      ...
      <div className="space-y-4">
        <h4 className="text-md font-semibold text-white">Ödeme Güvenliği</h4>
        <p className="text-gray-200 text-sm leading-relaxed">
      ...
      <div className="space-y-4">
        <h4 className="text-md font-semibold text-white">KVKK Kapsamındaki Haklarınız</h4>
        <p className="text-gray-200 text-sm leading-relaxed">
      ...
      <div className="space-y-4">
        <h4 className="text-md font-semibold text-white">İletişim Bilgileri</h4>
        <p className="text-gray-200 text-sm leading-relaxed">
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="bg-black/95 backdrop-blur-xl border border-white/10 text-white max-w-4xl max-h-[90vh] overflow-hidden">
        ...
        <div className="mt-6 rounded-xl border border-white/10 bg-white/5 p-6 max-h-[60vh] overflow-y-auto">
